...
extension PreviewProvider {
    ...
    /// A singleton instance of DeveloperPreview for reusable preview data of CoinModel
    /// - Returns an instance of DeveloperPreview class
    static var dev: DeveloperPreview {
        return DeveloperPreview.default
    }
}

///A class to enable reuse for Previews which contains sample coin data (bitcoin)
class DeveloperPreview {
    
    static let `default` = DeveloperPreview()
    
    private init() {//can only be initialized within class
